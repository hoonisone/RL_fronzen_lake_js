...
# class ConfigSpace:
#     def __init__(self, config:OmegaConf, search_space:dict):
...
#         return OmegaConf.merge(self.config, search_parameter)
...
#     conf_space = ConfigSpace(config=config, search_space=search_space)
